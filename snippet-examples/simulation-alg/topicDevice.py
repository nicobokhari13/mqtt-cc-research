import random 
# TODO: Double check that all topics are covered by the randomly generated device capabilities
    # for the future, loop through all topics, the chosen devices from all the devices list
