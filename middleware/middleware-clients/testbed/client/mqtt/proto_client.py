...
import testbed.client.mqtt.proto_db_previous as db
from testbed.client.mqtt.proto_utils_previous import ProtoUtils
import sys
import csv
...
def main():
    ...
    for i in range(len(rows)):
        ...
        status_handler.logTestBedMetrics(time=current_time, mac=mac, executions=0, power_instant=0, remaining_power=100, memory_util_perc=status_handler.getBrokerMemoryUtil(), cpu_util_perc=status_handler.getBrokerCpuUtil(), cpu_temp=status_handler.getBrokerCpuTemp())
