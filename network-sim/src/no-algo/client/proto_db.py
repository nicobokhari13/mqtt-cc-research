...
class Database:
    ...
    def __init__(self) -> None:
        self._db_path = "/home/devnico/repos/research/mqtt_cc_research/sqlite/mqttcc-noalgo.db"
    ...
    def getTopicsAndMaxAllowed(self, subscriptions):
        print(subscriptions)
        selectQuery = '''SELECT subscription, max_allowed_latency FROM subscriptions WHERE subscription = ?'''
        return self.execute_query_with_retry(query=selectQuery, values = subscriptions, executeMany=True)